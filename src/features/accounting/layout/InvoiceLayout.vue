...
<template>
    <div class="flex h-screen bg-[#F8FAFC] font-sans text-slate-700 overflow-hidden relative">
        ...
        <!-- Overlay Gelap (Hanya muncul di Mobile) -->
        ...
        <aside
            ...
            <div class="flex flex-col items-center w-full gap-6 lg:gap-8">
                <!-- Tombol Kembali Desktop (Kini Selalu Tampil di Layar Lebar) -->
        ...
        <main class="flex-1 overflow-y-auto p-4 pt-20 md:p-6 md:pt-24 lg:p-8 custom-scrollbar relative">
            <div class="mx-auto w-full h-full">
                <!-- Penambahan route di slot untuk trigger animasi -->
                <router-view v-slot="{ Component, route }">
                    <transition name="fade" mode="out-in">
                        <!-- Wrapper wajib ini mencegah error transisi jika Component tidak memiliki akar tunggal -->
...
// Menutup sidebar mobile setiap kali URL berubah (pengguna pindah halaman)
...
/* Custom Scrollbar yang elegan untuk area Main */
