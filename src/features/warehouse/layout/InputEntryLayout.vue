    ...
    <div class="flex h-screen bg-[#F8FAFC] font-sans text-slate-700 overflow-hidden relative">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-slate-800 text-base md:text-lg">Warehouse Control</span>
            </div>
        ...
        <!-- Sidebar / Navigasi Kiri ala Akuntansi -->
        <aside
            ...
            <div class="flex flex-col items-center w-full gap-6 lg:gap-8">
                ...
                <div @click="kembali" class="mb-2 cursor-pointer hidden lg:block" title="Kembali ke Dashboard Utama">
                    <div
...
import { useNavWarehouse } from '../composables/useNavWarehouse'
